...
export default function page() {
    ...
    <div className='mx-auto my-auto select-none md:w-[500px]'>
        ...
        <div className='flex gap-1 bg-[#ffffff48] p-2 rounded-2xl border-l border-t border-[#fff]'>
            ...
            <button onClick={ () => setTab('room')} className={`w-1/2 py-3  border-t border-l border-white rounded-l-xl ${tab === 'room' ? 'bg-[#ffffff] shadow-xl shadow-[#ebeaea] backdrop-blur-2xl text-orange-500' : 'bg-[#ffffff9b]'} cursor-pointer `}>Create Room</button>
            <button onClick={ () => setTab('login')} className={`w-1/2 py-2  border-t border-r border-white rounded-r-xl ${tab === 'login' ? 'bg-[#ffffff] shadow-xl shadow-[#ebeaea] backdrop-blur-2xl text-orange-500' : 'bg-[#ffffff9b]'} cursor-pointer `}>Login</button>
        </div>
        ...
        {/* join room  */}
        {
            tab === 'room' && (
                ...
                <div className='mt-5 grid grid-cols-4 gap-2 mx-auto w-fit mb-2'>
